    ...
    public LlmResponseDto generateHeuristicFallback(String text) {
        ...
        if (matchesJava) {
            roles.add(RoleSuggestionDto.builder()
                    ...
                    .matchReason("Strong keyword match for Java, Spring Boot, REST APIs, and backend system development.")
                    .keySkills(List.of("Java", "Spring Boot", "REST API", "PostgreSQL", "JPA"))
                    .build());
        }
        ...
        if (matchesFrontend) {
            roles.add(RoleSuggestionDto.builder()
                    ...
                    .matchReason("Demonstrated capabilities across React frontend web development and application UI state management.")
                    .keySkills(List.of("React", "JavaScript", "HTML/CSS", "Vite", "UI Development"))
                    .build());
        }
        ...
        if (matchesAiData) {
            roles.add(RoleSuggestionDto.builder()
                    ...
                    .matchReason("Experience detected in data processing pipelines, AI integration, and analytical modeling.")
                    .keySkills(List.of("Python", "Data Pipelines", "AI Integration", "SQL"))
                    .build());
        }
        ...
        if (roles.isEmpty()) {
            roles.add(RoleSuggestionDto.builder()
                    ...
                    .keySkills(List.of("Software Engineering", "Problem Solving", "System Design"))
                    .build());
        }
